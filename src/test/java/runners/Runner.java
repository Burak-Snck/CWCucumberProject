...
@CucumberOptions(
    ...
    plugin = {
            "html:target55/reports/html-reports/default-cucumber-reports.html",//html formatında rapor için
...
//                "rerun:target/failedScenarios.txt",//Fail olan scenarioların kaydını alır ve sadece bu testlerin koşulmasına yardımcı olur.
        ...
        tags = " @MapDataTable",//Özel olarak çalıştırılacak Scenario yada Feature Tag'i buraya belirtilir
